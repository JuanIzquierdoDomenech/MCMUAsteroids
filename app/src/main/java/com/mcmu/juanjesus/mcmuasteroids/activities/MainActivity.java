...
import com.mcmu.juanjesus.mcmuasteroids.score_storage.HostinazoWebServiceScoreStorage;
...
import com.mcmu.juanjesus.mcmuasteroids.score_storage.SQLiteRelScoreStorage;
import com.mcmu.juanjesus.mcmuasteroids.score_storage.SQLiteScoreStorage;
import com.mcmu.juanjesus.mcmuasteroids.score_storage.ScoreStorage;
import com.mcmu.juanjesus.mcmuasteroids.score_storage.SocketScoreStorage;
    ...
    protected void onResume() {
        ...
        switch (scoreStorageType) {
            ...
            case 7:
                ...
                break;
            case 8:
                Log.d("Score->Storage", "SQLiteScoreStorage");
                scoreStorage = new SQLiteScoreStorage(this);
                break;
            case 9:
            ...
            case 12:
                ...
                scoreStorage = new LocalXAMMPWebServiceScoreStorage(this);
                break;
            case 13:
                Log.d("Score->Storage", "HostinazoWebServiceScoreStorage");
                scoreStorage = new HostinazoWebServiceScoreStorage(this);
                break;
            default:
                break;
        }
